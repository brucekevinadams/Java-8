 ...
 * 
You will be given a square chess board with one queen and a number of obstacles placed on it. Determine how many
squares the queen can attack. A queen is standing on an n x n chessboard. The chess board's rows are numbered from 
1 to n, going from bottom to top. Its columns are numbered from 1 to n, going from left to right. Each square is
referenced by a tuple, (r,c) , describing the row, r, and column, c, where the square is located.
...
public class QueensAttackTwo {
	...
	public static void main(String[] args) {
		...
		// Calculates the distance to the closest obstacle in each direction and adds it
		// to reachableSquares
		// R B L T
